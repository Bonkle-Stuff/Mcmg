...
public class GameState {
  ...
  public GameState(String id, boolean enabledDefault) {
    this.id = id;
  ...
  public GameState addGameFunction(GameFunction gameFunction) {
    ...
    if (postRegister) {
      gameFunction.setEnabled(getEnabled());
      gameFunction.setIsTemporary(true);
    }
    return this;
  }
  ...
  public ArrayList<GameFunction> getGameFunctions() {
  ...
  public GameState setOnEnable(Runnable onEnable) {
    this.onEnable = onEnable;
    return this;
  }
  
  public GameState setOnDisable(Runnable onDisable) {
